...
export function HelpPanel({
  ...
  return (
    <aside
      aria-label="Help"
      className="sticky top-0 self-start border-l border-rule min-w-[340px] max-w-[480px] flex-shrink-0 h-screen flex flex-col hig-glass-edge overflow-hidden transition-[max-width,min-width] duration-150 ease-out"
    >
