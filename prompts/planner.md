...
1. **The template wins.** When the template's instructions conflict with anything below, follow the template. The rules in this prompt are defaults for the `title` field and the JSON contract — they do NOT override the template's instructions about the markdown body.
