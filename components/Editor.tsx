...
export function Editor({
  ...
  useEffect(() => {
    ...
    const flush = () => {
      const existing = loadDraft(namespace);
      saveDraft(namespace, { ...draftRef.current, mode: existing.mode, knead: existing.knead, subtasks: existing.subtasks, reviewing: existing.reviewing, reviews: existing.reviews });
    };
